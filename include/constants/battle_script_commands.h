...
enum CmdVarious
{
    ...
    VARIOUS_DEBUG_PLAY_MOVE_ANIMATION,
    VARIOUS_DEBUG_INIT_MOVE_ANIMATION,
    VARIOUS_DEBUG_INCREMENT_MOVE_ANIMATION,
    VARIOUS_DEBUG_SET_NEW_MOVE_ANIMATION_PARAMS,
    VARIOUS_DEBUG_INIT_MOVE_TARGET
};
