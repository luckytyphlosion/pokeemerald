...
static const struct ListMenuItem sDebugMenu_Items_Utilities[] =
{
    ...
    [DEBUG_UTIL_MENU_ITEM_MOVE_ANIMS_SINGLES] = {COMPOUND_STRING("Move anims singles"), DEBUG_UTIL_MENU_ITEM_MOVE_ANIMS_SINGLES},
    [DEBUG_UTIL_MENU_ITEM_MOVE_ANIMS_DOUBLES] = {COMPOUND_STRING("Move anims doubles"), DEBUG_UTIL_MENU_ITEM_MOVE_ANIMS_DOUBLES},
};
